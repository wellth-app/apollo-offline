...
exports.offlineEffect = (store, client, effect, action, callback) => __awaiter(this, void 0, void 0, function* () {
    const execute = true;
    const { optimisticResponse: originalOptimisticResponse, operation: { variables, query: mutation, context }, update, fetchPolicy, observer, } = effect;
        ...
        observable.subscribe({
            next: (data) => {
                ...
                enqueuedMutations
                    ...
                    const { operation: { variables = {}, query: document = null } = {}, update, optimisticResponse: originalOptimisticResponse, fetchPolicy, } = effect;
