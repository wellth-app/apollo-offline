...
const replaceUsingMap_1 = require("./replaceUsingMap");
describe("replaceUsingMap", () => {
    it("replaces expected values", () => {
        ...
        expect(replaceUsingMap_1.replaceUsingMap(source, map)).toEqual(expected);
    });
...
//# sourceMappingURL=replaceUsingMap.test.js.map