...
exports.createOfflineStore = (_a) => {
    ...
    const store = redux_1.createStore(redux_1.combineReducers(Object.assign({ rehydrated: rehydrated_1.default, [constants_1.NORMALIZED_CACHE_KEY]: cache_1.default }, reducer({ dataIdFromObject }))), typeof window !== "undefined" &&
        ...
        window.__REDUX_DEVTOOLS_EXTENSION__(), redux_1.compose(redux_1.applyMiddleware(redux_thunk_1.default, ...middleware), redux_offline_1.offline(Object.assign({}, defaults_1.default, offlineConfig, { persistCallback: () => {
            logger("Persistence loaded");
            persistCallback();
        }, persistOptions: Object.assign({}, (storage && { storage }), { whitelist: ["offline", constants_1.NORMALIZED_CACHE_KEY, constants_1.METADATA_KEY] }) }))));
    return store;
};
