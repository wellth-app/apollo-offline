...
exports.offlineEffect = (dataIdFromObject) => (state, action) => {
    ...
    switch (type) {
        ...
        default: {
            ...
            const idsMap = idsMap_1.default(originalIdsMap, Object.assign(Object.assign({}, action), { remainingMutations: snapshot.enqueuedMutations }), dataIdFromObject);
            return Object.assign(Object.assign({}, restState), { snapshot,
                idsMap });
        }
    }
};
