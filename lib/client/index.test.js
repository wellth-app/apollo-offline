...
const getClient = (options) => {
    ...
    return new _1.ApolloOfflineClient(Object.assign({}, defaultOptions, options, { offlineConfig: Object.assign({}, defaultOptions.offlineConfig, options.offlineConfig) }));
};
class MemoryStorage {
...
describe("ApolloOfflineClient", () => {
  ...
  `;
    ...
    describe("Offline disabled", () => {
        ...
        it("updates the cache with the server response", (done) => __awaiter(this, void 0, void 0, function* () {
    ...
    describe("Offline enabled", () => {
        ...
        describe("enqueued effects", () => {
            describe("context", () => {
                it("preserves an operation's custom context applied via link", (done) => __awaiter(this, void 0, void 0, function* () {
                    setNetworkOnlineStatus(true);
                    const context = {
                        customContext: {
                            key: "Value",
                ...
                it("preserves an operation's custom context applied via mutate options", (done) => __awaiter(this, void 0, void 0, function* () {
                    setNetworkOnlineStatus(true);
                    const context = {
                        customContextKey: {
                            deepNestedObject: {
        ...
        describe("Online", () => {
            ...
            it("updates the cache with the optimistic response", (done) => __awaiter(this, void 0, void 0, function* () {
                yield client.mutate({
                    mutation,
                    variables,
                    optimisticResponse,
            ...
            describe("error handling", () => {
                it("removes optimistic responses from the cache if the request is to be discarded (GraphQLErrors)", () => __awaiter(this, void 0, void 0, function* () {
