...
const createNetworkLink = (store, disableOffline = false, offlineLink, onlineLink) => apollo_link_1.ApolloLink.from([
    offlineLink,
    disableOffline ? null : new offline_1.default(store),
    onlineLink,
].filter(Boolean));
class ApolloOfflineClient extends apollo_client_1.default {
    constructor({ disableOffline = false, reduxMiddleware = [], offlineLink = null, onlineLink = null, cacheOptions = {}, offlineConfig: { discardCondition, callback: offlineCallback = undefined, storage = undefined, storeCacheRootMutation = false, }, }, _a = {}) {
        ...
        const store = disableOffline
            ...
            : store_1.createOfflineStore({
                ...
                effect: (effect, action) => offline_1.offlineEffect(store, this, effect, action, offlineCallback),
