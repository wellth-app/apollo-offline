...
export default class ApolloOfflineClient<T extends NormalizedCacheObject> extends ApolloClient<T> {
    ...
    constructor({ disableOffline, reduxMiddleware, offlineLink, onlineLink, cacheOptions, offlineConfig: { discardCondition, callback: offlineCallback, storage, storeCacheRootMutation, }, }: ApolloOfflineClientOptions, { cache: customCache, link: customLink, ...clientOptions }?: Partial<ApolloClientOptions<T>>);
